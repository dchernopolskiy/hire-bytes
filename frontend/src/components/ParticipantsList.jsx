...
export const ParticipantsList = ({
  ...
  return (
    <div 
      className="absolute top-16 right-4 w-72 bg-gray-800/95 rounded-lg shadow-xl backdrop-blur-sm 
    ...
    >
      <div className="p-4">
        <div className="flex items-center justify-between mb-4">
          ...
          <button
            onClick={onClose}
            className="p-1 hover:bg-gray-700/50 rounded-md text-gray-400 transition-colors"
          >
            <X className="w-4 h-4" />
          </button>
        </div>
        ...
        <div className="space-y-2">
          {participants.map((participant) => (
            <div
              ...
              className="flex items-center justify-between p-3 rounded-md bg-gray-700/30 
                ...
                <div>
                  <div className="flex items-center space-x-2">
                    ...
                    {participant.userId === localStorage.getItem('userId') && (
                      <span className="text-xs bg-blue-500/20 text-blue-400 px-1.5 
                        py-0.5 rounded">You</span>
                    )}
              ...
              {isCreator && participant.userId !== localStorage.getItem('userId') && (
                <div className="flex gap-2">
                  ...
                  <button
                    ...
                    className="p-1.5 rounded-md bg-red-500/20 text-red-500 
